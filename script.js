var stateObject ={
    ...
    window.onload = function () {
        ...
        for (var district in stateObject) {
    ...
    cityselect.onchange = function () {
        ...
        var barangay = stateObject[districtselect.value][this.value];
        for (var i = 0; i < barangay.length; i++) {
            barangayselect.options[barangayselect.options.length] = new Option(barangay[i], barangay[i]);
            }
        }
    }